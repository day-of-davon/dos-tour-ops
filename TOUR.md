...
## EU advance status (as of 2026-04-23)

| Date | City | Venue | Promoter | Production contact | Advance status |
|---|---|---|---|---|---|
| May 4 | Dublin | National Stadium | MCD / Zach Desmond | Brian Fluskey (brianfluskey@gmail.com) | Initiated Apr 10, awaiting reply |
| May 5 | Dublin | National Stadium | MCD / Zach Desmond | Brian Fluskey | Same thread |
| May 7 | Manchester | O2 Victoria Warehouse | LN UK / Kiarn Eslami | Tyrone (tyrone84@gmail.com) | Initiated Apr 10, awaiting reply |
| May 8 | Manchester | O2 Victoria Warehouse | LN UK | Tyrone | Same thread |
| May 10 | Glasgow | O2 Academy | DF Concerts | Charmaine Hardman (charmaine.hardman@dfconcerts.co.uk) | Initiated Apr 10, awaiting reply |
...
| May 22 | Milan | Fabrique | LN IT | Andrea Aurigo (andrea.aurigo@livenation.it) | **Not in intel — advance not yet sent** |
| May 24 | Prague | SaSaZu | Fource | Barbora Rehorova (bara@fource.com) | In progress Apr 11 (intro via Freya) |
| May 26 | Berlin | Columbiahalle | LN DE | Oli Zimmermann (oliver.zimmermann@livenation-production.de) | **Not in intel — advance not yet sent** |
| May 28 | Bratislava | Majestic Music Club | LN HU | Peter Lipovsky (peter.lipovsky@gmail.com) | Initiated Apr 10, awaiting reply |
| May 30 | Warsaw | Orange Festival | AlterArt | **No contact in system** | **Not started — add contact + send** |

### EU advance gaps to close

- [ ] Amsterdam May 19 — send advance to John Cameron (j.cameron@mojo.nl).
- [ ] Milan May 22 — send advance to Andrea Aurigo (andrea.aurigo@livenation.it).
...
- **Jun 26:** Chambord Live, Chambord — LN SAS — ⚠ immigration forms outstanding. No advance contact in system.
- **Jun 28:** Le Transbordeur, Villeurbanne — LN SAS — ⚠ immigration forms outstanding. No advance contact in system.
...
- Jul 12: Ottawa, Ottawa Bluesfest — promoter TBD.
...
- **Insurance:** $0. CRITICAL. Route to Sam/Sandro immediately.
- **FR immigration:** Outstanding for Paris (May 20), Chambord (Jun 26), Villeurbanne (Jun 28).
- **Wasserman UK form:** Outstanding since Apr 9.
- **Warsaw advance contact:** AlterArt — no production contact in system.
