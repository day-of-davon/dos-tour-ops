...
Euro leg 2. VENUE RESOLVED 06-10: Monica Gasull (Primavera) confirmed "this show is in Razzmatazz" (not Sala Apolo). File kept under old sala-apolo slug.

## Booking / Confirm
- Confirmed: Thu Jun 25, Razzmatazz, Barcelona.

## Advance
- 06-09 OPENED. Davon emailed Ivone Lesan (ivone.lesan@primaverasound.com) to open advance for "Razzmatazz, June 25" and request advancing contacts; CC Mike Sheck + Dan Nudelman.
- 06-09 Ivone connected: Monica Gasull (monica.gasull@primaverasound.com, +34 620778180) = production; Alan Jaén (alan.jaen@primaverasound.com) = hospitality; Abel Gonzalez (agonzalez@primaverasound.com) = promoter (keep on CC).
- 06-10 Davon sent full advance to Monica + party (8 pax fly-in, no vehicles). Arrive from Lisbon on VY8461, landing BCN 12:10p Jun 25. Traveling FOH only (Ruairi); need house monitor engineer; Dan confirms if house LD needed.
...
- [ ] Confirm lighting floor-package quote once Monica sends it.
- [ ] Alan Jaén to send wifi, GL, hospitality buyout, runner rate.
