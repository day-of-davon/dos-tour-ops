---
event: Ottawa Bluesfest, Ottawa ON
date: 2026-07-12
event_id: TBD
stage: Travel
updated: 2026-06-15
...
## Booking / Confirm
- bbno$ NA festival date, 12 Jul. Paired same-charter with [[2026-07-11-mohegan-sun]] (prior day).
...
- Invoice entity: bbno$ Shows Inc., Vancouver BC. Payment via DMCL + mgmt. Status 06-05: awaiting final docs from operator.
- **06-14 CHARTER AT RISK: Sam Alavi — cancel and drive if not paid (see [[2026-07-11-mohegan-sun]]).** If charter falls, Mohegan Sun (CT) → Ottawa (ON) becomes a long drive + border crossing between back-to-back festival days; raises the Claire Morris immigration filing from important to blocking.
