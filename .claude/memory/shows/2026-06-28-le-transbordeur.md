---
event: Le Transbordeur, Villeurbanne (Lyon), France
date: 2026-06-28
event_id: TBD
stage: Travel
updated: 2026-06-15
...
- 06-09 Festival rider sent to Live Nation France (Alex Applegate; Damien Chamard-Boudet CC) covering this show + Chambord; Davon asked LN FR to open technical advance for both. Awaiting Lyon advancing contacts. See [[2026-06-26-chambord]].
- 06-10 Davon opened the Lyon advance in its own thread to Damien Chamard-Boudet (LN FR), CC Applegate/Sheck/Nudelman/Matthews. Current riders (production + hospitality google docs); disregard earlier Wasserman versions. Party 8 pax, fly-in, arrive from Chambord by 1 Sprinter van (asked venue to confirm van parking). Show format: DJ Tip 30m, Jungle Bobby 30m, 15m changeover, bbno$ 105m. Need house monitor engineer + house LD/operator; venue tech pack requested. Backline provided per rider. Merch via Allotment/A3 (Danny Samet).
...
- [ ] **REPLY OWED to Cyril**: send backline list so he can price the quote. Confirm LED wall decision (tour source vs Cyril sources locally).
- [ ] Get show-day times/curfew, day-of POC, GL allotment, settlement/wire details from Cyril/LN FR.
- [ ] Finalize Sprinter vendor + confirm drop location (Lyon vs Paris).
- [ ] CONFIRM FR immigration/work-permit status with Thibaut Lagarde (Chambord + Lyon).

## Sources (Gmail thread ids + last seen)
- 19eb08f0496fdf89 — bbno$ @ Le Transbordeur, Lyon - June 28 | Advance (Cyril reply: venue tech specs sent; backline list missing from rider; no LED wall on site) — 2026-06-10
